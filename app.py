...
def extraer_con_ia(imagen_b64, mime, campo=""):
    if campo == FIMASA3:
        ...
        prompt = (
            ...
            "SOLO debes leer: PS, OXIGENO AM, OXIGENO PM, TEMPERATURA AM, TEMPERATURA PM. "
            "IGNORA completamente las columnas: TB CM, COLOR, CALIBRACION ENT, CALIBRACION SALID, NIVEL cm, SAL %. "
            ...
            "Busca activamente las palabras PRECRIAS (o variantes: PRECRIA, Precrias) y RESERVORIO (o variantes: RESERUORIO, RESERV) escritas en cualquier parte del block como titulo o en la columna PS. "
